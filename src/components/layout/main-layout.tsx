...
export default function MainLayout({ children }: PropsWithChildren) {
  return (
    <div className="absolute flex min-h-screen w-full   overflow-hidden">
      {/* <BackgroundLines className="z-0 absolute inset-0" children={undefined}>
      </BackgroundLines> */}
      ...
      <Sidebar collapsible="icon" variant="floating" side="left" className="">
        ...
        <SidebarContent className="flex-1 p-4 overflow-y-hidden"> {/* SidebarNav goes here */}
          <SidebarNav />
        </SidebarContent>


        <SidebarFooter className=" pt-0 w-auto mt-auto">
           {/* User Profile Card */}
           <div className="p-3 rounded-lg bg-card text-card-foreground shadow-md group-data-[collapsible=icon]:p-2">
            <div className="flex items-center gap-3 group-data-[collapsible=icon]:flex-col group-data-[collapsible=icon]:items-center group-data-[collapsible=icon]:gap-2">
              <Avatar className="h-8 w-10">
                <AvatarImage src="https://lunaredgeit.com/assets/logo-Bh31_VE1.webp" alt="User Avatar" data-ai-hint="user avatar" />
                <AvatarFallback>NC</AvatarFallback>
              </Avatar>
              <div className="group-data-[collapsible=icon]:hidden">
                <p className="text-sm font-medium">Team LunarEdge</p>
                <p className="text-xs text-muted-foreground">Server@lunaredgeit.com</p>
              </div>
            </div>
            <Button variant="ghost" className="w-full border border-muted justify-start mt-3  group-data-[collapsible=icon]:justify-center group-data-[collapsible=icon]:mt-2 group-data-[collapsible=icon]:w-auto group-data-[collapsible=icon]:p-1 group-data-[collapsible=icon]:h-auto">
      ...
      <SidebarInset className="min-h-[98%] w-full  flex  items-center flex-col overflow-y-auto">
